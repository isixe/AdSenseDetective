            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <Card className="shadow-md">
                  ...
                  <CardContent className="pb-6 pt-0 text-center text-sm text-muted-foreground">
                    <p>
                      Identify all HTML and AMP ad units on a page, detailing
                      their client and slot IDs for easy verification.
                    </p>
                  </CardContent>
                </Card>
                <Card className="shadow-md">
                  ...
                  <CardContent className="pb-6 pt-0 text-center text-sm text-muted-foreground">
                    <p>
                      ...
                      configuration for efficient troubleshooting and
                      optimization.
                    </p>
                  </CardContent>
                </Card>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div className="pt-3">
                    ...
                    <p className="mb-3 text-xs text-muted-foreground">
                      ...
                      &#39;ads.txt&#39; file, OR the &#39;adsbygoogle.js&#39;
                      script (with client ID) is found.
                    </p>
                    ...
                    <div className="space-y-3 border-l-2 border-primary/20 pl-3">
                          ...
                          <>
                            ...
                            state.metaTagContent.trim() !== '' ? (
                              ...
                              <p className="mt-1 rounded-md border border-amber-200 bg-amber-50 p-2 text-xs text-amber-600 dark:border-amber-700 dark:bg-amber-900/30 dark:text-amber-400">
                                Meta tag found, but its &#39;content&#39;
                                attribute is empty.
                              </p>
                            ) : (
                              <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                Meta tag found, but &#39;content&#39; attribute
                                might be missing or unreadable.
                              </p>
                            )}
                          </>
                        ) : (
                          <p className="mt-1 text-xs text-muted-foreground">
                            The &#39;google-adsense-account&#39; meta tag was
                            not detected in the site&#39;s HTML.
                          </p>
                        )}
                      </div>
                      ...
                      <div className="rounded-md border bg-slate-50 p-3 shadow-sm dark:border-slate-700 dark:bg-slate-800/40">
                        ...
                        {state.adsTxtFound ? (
                            ...
                            {state.adsTxtIsHtmlOrEmpty ? (
                              ...
                              >
                                ...
                                <AlertDescription className="ml-1">
                                  ads.txt file is present, but its content
                                  appears to be an HTML page (e.g., a custom
                                  404) or is empty.
                                  {state.adsTxtContent &&
                              ...
                              >
                                <AlertTriangle className="h-4 w-4 text-amber-500 dark:text-amber-400" />
                                <AlertDescription className="ml-1">
                                  ads.txt file is present, but content could not
                                  be retrieved or is empty (after trimming).
                                </AlertDescription>
                              </Alert>
                            )}
                          </>
                          ...
                          <p className="mt-1 text-xs text-muted-foreground">
                            The ads.txt file was not found or is not accessible
                      ...
                      <div className="rounded-md border bg-slate-50 p-3 shadow-sm dark:border-slate-700 dark:bg-slate-800/40">
                        ...
                        {state.adsbygoogleScriptFound ? (
                          <p className="mt-1 text-xs text-muted-foreground">
                            The AdSense core script (&#39;adsbygoogle.js&#39;)
                            with a client ID was detected in the site&#39;s
                            HTML.
                          </p>
                        ) : (
                          <p className="mt-1 text-xs text-muted-foreground">
                            The AdSense core script (&#39;adsbygoogle.js&#39;)
                            with a client ID was not detected.
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="pt-3">
                    ...
                    <Tabs
                      defaultValue={adUnitTabDefaultValue}
                      className="w-full"
                    >
                        ...
                        <div className="mt-2 space-y-4 border-l-2 border-primary/20 pl-3">
                          ...
                          <div className="border-t border-dashed border-slate-300 pt-3 dark:border-slate-700">
                            ...
                            {state.ampAdUnits.length > 0 ? (
                              <div className="space-y-3">
                                {state.ampAdUnits.map((unit, index) => (
                                  <AmpAdUnitItem
                                    key={index}
                                    unit={unit}
                                    index={index}
...
function ResultItem({ label, found, Icon, description }: ResultItemProps) {
  return (
    <div className="rounded-md border bg-slate-50 p-3 shadow-sm dark:border-slate-700 dark:bg-slate-800/40">
...
interface AdUnitItemProps {
  unit: AdUnitDetail
  index: number
}

function AdUnitItem({ unit, index }: AdUnitItemProps) {
  return (
...
function AmpAdUnitItem({ unit, index }: AmpAdUnitItemProps) {
  return (
    <div className="rounded-md border bg-slate-100 p-4 shadow-sm dark:border-slate-700 dark:bg-slate-800/60">
      <p className="font-headline mb-2 text-sm font-medium text-primary">
